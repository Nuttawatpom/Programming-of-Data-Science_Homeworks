...
def grp_reports(stu_list):
    ...
    roomList = {"01": None,"02": None,"03": None,"04": None,"05":None}
    roomWordList = ["01","02","03","04","05"]
    room=[[],[],[],[],[]]
    ...
    num = 0
    for i in roomWordList:
        roomList[i] = tuple(room[num])
        num+=1
    return(genderList,roomList)
